...
const EditMenu = ({
    ...
    return ( <
        ...
        <
        div style = {
            { paddingLeft: '10px', paddingTop: '5px', fontSize: '17px' }
        } >
        <
        div style = {
            { paddingBottom: '45px', paddingRight: '10px', display: 'flex', width: '160px' }
        } >
        Sales Order Amount <
        /div> <
        div style = {
        ...
        <
        Input className = { isErrorNewInvoiceAmount ? classes.ErrorInputBox : classes.InputBox }
...
const EditInvoicePage = ({
    ...
    const handleSave = () => {
        if (newInvoiceAmount !== '') {
            axios.post('http://localhost8080/H2HBABBA3061/EditSalesOrder', {
                    invoiceNumber,
                    newInvoiceAmount,
                    newNotes
                })
    ...
    return ( <
        ...
        <
        EditMenu invoiceAmount = { invoiceAmount }
        notes = { notes }
        newInvoiceAmount = { newInvoiceAmount }
        setNewInvoiceAmount = { setNewInvoiceAmount }
        newNotes = { newNotes }
        ...
        <
        div style = {
            { position: 'fixed', left: '585px', paddingBottom: '10px' }
        } >
        <
        Button autofocus className = { classes.CancelButton }
        onClick = { handleClose } >
        Cancel <
        /Button> < /
        div > <
        ...
        <
        Button autofocus className = { classes.ResetButton }
        ...
        <
        Button autofocus className = { classes.SaveButton }
