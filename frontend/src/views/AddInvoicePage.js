...
const MandatoryFieldsPopUp = ({ open, setOpen }) => {
    ...
    return ( <
        ...
        /div> <
        div >
        Mandatory fields can 't be empty < /div > <
        div style = {
...
const DatePicker = ({ dueDate, setDueDate, setAddButtonClicked, isErrorDueDate }) => {
    ...
    return ( <
        ...
        <
        KeyboardDatePicker className = { isErrorDueDate ? classes.ErrorInputBox : classes.InputBox }
...
const AddMenu = ({
    ...
    return ( <
        ...
        <
        div style = {
            { display: 'flex', flexDirection: 'column', paddingRight: '30px', paddingTop: '5px', fontSize: '17px' }
        } >
        <
        div style = {
            { paddingBottom: '45px', display: 'flex' }
        } >
        Customer Name < div style = {
        ...
        <
        Input className = { isErrorCustomerName ? classes.ErrorInputBox : classes.InputBox }
        disableUnderline = { true }
        required = { true }
        value = { customerName }
        onChange = {
            (event) => handleCustomerName(event)
        }
        ...
        <
        Input className = { isErrorCustomerNumber ? classes.ErrorInputBox : classes.InputBox }
        disableUnderline = { true }
        required = { true }
        value = { customerNumber }
        onChange = {
            (event) => handleCustomerNumber(event)
        }
        ...
        <
        Input className = { isErrorInvoiceNumber ? classes.ErrorInputBox : classes.InputBox }
        disableUnderline = { true }
        required = { true }
        value = { invoiceNumber }
        onChange = {
            (event) => handleInvoiceNumber(event)
        }
        ...
        div >
        <
        Input className = { isErrorInvoiceAmount ? classes.ErrorInputBox : classes.InputBox }
        disableUnderline = { true }
        required = { true }
        value = { invoiceAmount }
        onChange = {
            (event) => handleInvoiceAmount(event)
        }
        ...
        style = {
            { height: '170px', width: '230px' }
        }
        disableUnderline = { true }
        value = { notes }
        onChange = {
            (event) => handleNotes(event)
        } >
        <
        /Input> < /
        div > <
...
const AddInvoicePage = ({ open, setOpen, setDataPageCount, setData }) => {
    ...
    const handleAddButton = () => {
        ...
        if (
            ...
            axios.post(
                    'http://localhost8080/H2HBABBA3061/AddInvoice', {
                        customerName,
                        customerNumber,
                        invoiceNumber,
                        invoiceAmount,
    ...
    return ( <
        ...
        MuiDialogContent className = { classes.Body } >
        <
        AddMenu customerName = { customerName }
        ...
        MuiDialogActions style = {
            { background: '#2A3E4C', borderRadius: '0px 0px 10px 10px' }
        } >
        <
        div onClick = { handleClose }
        style = {
            { position: 'fixed', left: '350px', paddingBottom: '10px' }
        } >
        <
        ...
        <
        Button autofocus className = { classes.ClearButton }
        ...
        <
        Button autofocus className = { classes.AddButton }
        ...
        Fragment >
        <
        MandatoryFieldsPopUp open = { openMandatoryFieldsPopUp }
